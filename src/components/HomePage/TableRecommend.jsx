...
export default function TableRecommend() {
    ...
    useEffect(() => {
        const fetchRecommendations = async () => {
            ...
            const sorted = data.sort((a, b) => a.seriesIssue - b.seriesIssue);
    ...
    return (
        <div className="flex flex-col items-center justify-center w-[100%] max-w-[1200px] mx-auto mt-10 ">
                ...
                <table className="w-full border-collapse mb-2 border-[#4f4e4e] text-white text-sm ">
                    ...
                    {comicTable.map((item, i  ) => (
                        <tr key={item.id} className="h-24">
                            ...
                            <Link to={`/${character}/${title}/${item.series_issue}`}>
